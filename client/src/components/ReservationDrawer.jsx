        ...
        <DrawerContent>
          ...
          <DrawerBody>
            {loading ? (
              ...
              <Select placeholder="Select service">
                {services?.map((service) => {
                  return (
                    <option value="option1">{service.service_title}</option>
                  );
                })}
              </Select>
            )}
            ...
            <Text fontSize="18" pt="5">
              Would you like to book your appointment with a specific staff
              member?[optional]
            </Text>

            <Select placeholder="Select staff [optional]">
              {staff?.map((staff) => {
                return <option value="option1">{staff.first_name}</option>;
              })}
            </Select>
            ...
            <Text
              ...
              pb="10px"
            >
              PICK A STARTING TIME <CalendarIcon />
            </Text>
